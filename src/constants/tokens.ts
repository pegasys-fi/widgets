...
export const USDC_ROLLUX_TESTNET = new Token(
...
//   'Ampleforth'
// )
export const DAI_ROLLUX_TESTNET = new Token(
  SupportedChainId.ROLLUX_TESTNET,
...
export const USDC: { [chainId in SupportedChainId]: Token } = {
  [SupportedChainId.ROLLUX_TESTNET]: USDC_ROLLUX_TESTNET,
...
//   'Wrapped BTC'
// )
export const USDT_ROLLUX_TESTNET = new Token(
  SupportedChainId.ROLLUX_TESTNET,
...
export const UNI: { [chainId: number]: Token } = {
  [SupportedChainId.ROLLUX_TESTNET]: new Token(SupportedChainId.ROLLUX_TESTNET, UNI_ADDRESS[SupportedChainId.ROLLUX_TESTNET], 18, 'UNI', 'Uniswap'),
...
export const TOKEN_SHORTHANDS: { [shorthand: string]: { [chainId in SupportedChainId]?: string } } = {
  USDC: {
    [SupportedChainId.ROLLUX_TESTNET]: USDC_ROLLUX_TESTNET.address,
